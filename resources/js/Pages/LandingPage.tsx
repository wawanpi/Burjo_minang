...
function Divider({ light = false }: { light?: boolean }) {
    return (
        <div className="flex items-center justify-center gap-3 my-2">
            <span className={`block h-px w-12 ${light ? 'bg-gold-400/40' : 'bg-brand-700/30'}`} />
            <span className={`text-lg ${light ? 'text-gold-400' : 'text-brand-700'}`}>✦</span>
            <span className={`block h-px w-12 ${light ? 'bg-gold-400/40' : 'bg-brand-700/30'}`} />
        </div>
    );
}
        ...
        >
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    ...
                    <a href="#beranda" className="flex items-center gap-3 group">
                        <div className="flex flex-col items-start">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                <span className="block h-px w-5 bg-gold-400/60" />
                                <span className="text-[9px] sm:text-[10px] tracking-[0.3em] uppercase text-gold-400 font-medium leading-none">
                                    Cita Rasa Autentik
                                </span>
                                <span className="block h-px w-5 bg-gold-400/60" />
                            </div>
                    ...
                    <div className="hidden md:flex items-center gap-1">
                        ...
                        <Link
                            href={route('login')}
                            className={`ml-4 px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 hover:scale-105 ${
                                scrolled
                                    ? 'bg-gold-400 text-gray-950 hover:bg-gold-500 shadow-lg shadow-gold-400/20'
            ...
            <div className={`md:hidden overflow-hidden transition-all duration-400 ease-in-out ${
                ...
                <div className="bg-gray-950/90 backdrop-blur-2xl border-t border-white/10 px-6 py-4 space-y-1">
                    ...
                    <Link
                        href={route('login')}
                        className="block text-center mt-3 px-4 py-3 rounded-full bg-gold-400 text-gray-950 text-sm font-semibold hover:bg-gold-500 transition-colors"
                    >
                        Masuk
                    </Link>
                </div>
        ...
        <section id="beranda" className="relative h-screen w-full overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
                ...
                <h1 className={`mt-8 font-serif font-bold text-white leading-[0.95] transition-all duration-1000 delay-200 ${
                    ...
                    <span className="block text-6xl sm:text-7xl md:text-8xl lg:text-9xl text-gold-400 mt-1">
                        Minang
                    </span>
                </h1>
                ...
                <div className={`mt-10 flex flex-col sm:flex-row gap-4 transition-all duration-1000 delay-[1100ms] ${
                    ...
                    <a
                        href="#menu"
                        className="group px-8 py-4 bg-brand-700 hover:bg-brand-800 text-white rounded-full font-semibold text-sm tracking-wide transition-all duration-300 hover:scale-105 shadow-xl shadow-brand-900/30 flex items-center gap-2"
                    >
                        Lihat Menu
                ...
                {HERO_SLIDES.map((_, i) => (
                    <button
                        ...
                        className={`h-1.5 rounded-full transition-all duration-500 ${
                            i === current ? 'w-10 bg-gold-400' : 'w-4 bg-white/30 hover:bg-white/50'
                        }`}
            ...
            <div className="absolute bottom-0 left-0 right-0">
                <svg viewBox="0 0 1440 80" fill="none" className="w-full">
                    <path d="M0 80h1440V30c-240 35-480 50-720 50S240 65 0 30v50z" fill="#FFF8F0" />
                </svg>
            </div>
        </section>
    );
...
function AboutSection() {
    ...
    return (
        <section id="tentang" className="bg-cream relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
                    ...
                    <div ref={ref1} className="reveal-left order-2 lg:order-1">
                        <span className="inline-block text-brand-700 text-xs font-bold tracking-[0.3em] uppercase mb-4">
                            Tentang Kami
                        </span>
                        <Divider />
                        <h2 className="mt-4 font-serif text-4xl sm:text-5xl font-bold text-gray-900 leading-tight">
                            Menghadirkan
                            <span className="block text-brand-700 mt-1">Cita Rasa Minang</span>
                            ke Meja Anda
                        </h2>
                        ...
                        <div className="mt-10 grid grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={stat.label} className="text-center lg:text-left">
                                    <div className="text-2xl lg:text-3xl font-serif font-bold text-brand-700">
                                        {stat.value}
                                    </div>
                    ...
                    <div ref={ref2} className="reveal-right order-1 lg:order-2 relative">
                        <div className="relative">
                            {/* Main image */}
                            <div className="rounded-3xl overflow-hidden shadow-2xl shadow-brand-900/10 aspect-[4/5]">
                                <img
                            ...
                            <div className="absolute -bottom-8 -left-8 w-40 h-40 lg:w-52 lg:h-52 rounded-2xl overflow-hidden shadow-xl border-4 border-cream animate-float hidden sm:block">
                                <img
                            ...
                            {/* Experience badge */}
                            <div ref={ref3} className="reveal-scale absolute -top-4 -right-4 lg:-right-6 bg-brand-700 text-white rounded-2xl p-5 shadow-xl shadow-brand-900/30">
                                <div className="text-3xl font-serif font-bold text-gold-400">5+</div>
        ...
        <section id="menu" className="bg-white relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 -translate-y-[1px]">
                <svg viewBox="0 0 1440 60" fill="none" className="w-full">
                    <path d="M0 0h1440v30C1200 0 960-10 720 10 480 30 240 60 0 30V0z" fill="#FFF8F0" />
                </svg>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
                ...
                <div ref={headerRef} className="reveal text-center max-w-2xl mx-auto mb-16">
                    ...
                    <Divider />
                    <h2 className="mt-4 font-serif text-4xl sm:text-5xl font-bold text-gray-900 leading-tight">
                        Sajian <span className="text-brand-700">Terbaik</span> Kami
                    </h2>
                ...
                <div className="text-center mt-16">
                    <Link
                        href={route('login')}
                        className="group inline-flex items-center gap-2 px-8 py-4 bg-brand-700 hover:bg-brand-800 text-white rounded-full font-semibold text-sm tracking-wide transition-all duration-300 hover:scale-105 shadow-xl shadow-brand-900/20"
                    >
                        Lihat Semua Menu
                        <svg className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                    </Link>
...
function MenuCard({ item, delay }: { item: typeof FEATURED_MENUS[0]; delay: number }) {
    ...
    return (
        ...
        >
            <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-brand-900/10 transition-all duration-500 hover:-translate-y-2">
                {/* Image */}
                <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    {/* Tag Badge */}
                    <span className="absolute top-4 left-4 px-3 py-1.5 bg-brand-700/90 backdrop-blur-sm text-white text-[10px] font-bold tracking-widest uppercase rounded-full">
                        {item.tag}
                    </span>
                    ...
                    <div className="absolute bottom-4 right-4 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-400">
                        <span className="px-4 py-2 bg-white/90 backdrop-blur-sm rounded-full text-brand-700 font-bold text-sm shadow-lg">
                            {item.price}
                        </span>
                    </div>
                </div>
                ...
                {/* Content */}
                <div className="p-6">
                    <h3 className="font-serif font-bold text-lg text-gray-900 group-hover:text-brand-700 transition-colors duration-300">
                        {item.name}
                    </h3>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                        <span className="text-brand-700 font-bold text-lg">{item.price}</span>
                        <button className="w-9 h-9 rounded-full bg-brand-50 hover:bg-brand-700 text-brand-700 hover:text-white flex items-center justify-center transition-all duration-300 group-hover:scale-110">
...
function Footer() {
    return (
        <footer id="kontak" className="bg-gray-950 text-white relative overflow-hidden">
            ...
            <div className="h-1 bg-gradient-to-r from-brand-900 via-brand-700 to-gold-400" />
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="mb-6">
                            ...
                            <div className="flex items-center gap-2 mt-1.5">
                                <span className="block h-px w-5 bg-gold-400/60" />
                                <span className="text-[10px] tracking-[0.3em] uppercase text-gold-400 font-medium leading-none">
                                    Cita Rasa Autentik
                                </span>
                                <span className="block h-px w-5 bg-gold-400/60" />
                            </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            {NAV_LINKS.map((link) => (
                                <li key={link.href}>
                                    <a href={link.href} className="text-gray-400 hover:text-gold-400 text-sm transition-colors duration-300 flex items-center gap-2 group">
                                        <span className="w-1 h-1 bg-brand-700 rounded-full group-hover:bg-gold-400 transition-colors duration-300" />
                                        {link.label}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            ...
                            <li className="flex items-center gap-3">
                                <svg className="w-5 h-5 text-brand-700 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                                +62 812-3456-7890
                            </li>
                            <li className="flex items-center gap-3">
                                <svg className="w-5 h-5 text-brand-700 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            {/* Instagram */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-brand-700 border border-white/10 hover:border-brand-700 flex items-center justify-center transition-all duration-300 hover:scale-110 group" aria-label="Instagram">
                            ...
                            {/* Facebook */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-brand-700 border border-white/10 hover:border-brand-700 flex items-center justify-center transition-all duration-300 hover:scale-110 group" aria-label="Facebook">
                                <svg className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                            </a>
                            {/* WhatsApp */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-brand-700 border border-white/10 hover:border-brand-700 flex items-center justify-center transition-all duration-300 hover:scale-110 group" aria-label="WhatsApp">
                            ...
                            {/* TikTok */}
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-brand-700 border border-white/10 hover:border-brand-700 flex items-center justify-center transition-all duration-300 hover:scale-110 group" aria-label="TikTok">
