...
export default function RegisterPage() {
  ...
  return (
    <>
      <Head title="Daftar Akun - Burjo Minang" />
        ...
        <div className="w-full lg:w-[55%] bg-white flex flex-col justify-center relative z-0 px-8 sm:px-12 lg:px-24 py-12">
            ...
            <div className="w-full max-w-md mx-auto">
                ...
                <div className={`transition-all duration-1000 ease-out delay-300 ${
                  ...
                  <h2 className="text-4xl font-bold text-gray-800 mb-2 text-center lg:text-left">Daftar Akun</h2>
                  <p className="text-gray-400 mb-10 text-sm text-center lg:text-left">Bergabunglah bersama kami! Silakan lengkapi data Anda.</p>
                </div>
                ...
                <form onSubmit={submit} className="space-y-5">
                    ...
                    {/* Input Email */}
                    <div className={`relative group transition-all duration-1000 ease-out delay-[500ms] ${
                      loaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'
                    }`}>
                    ...
                    {/* Input Nomor HP */}
                    <div className={`relative group transition-all duration-1000 ease-out delay-[550ms] ${
                      loaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'
                    }`}>
                        <label htmlFor="no_hp" className="block text-sm font-bold text-gray-700 mb-1">Nomor Handphone</label>
                        <input 
                            id="no_hp" 
                            type="tel" 
                            value={data.no_hp}
                    ...
                    {/* Input Password */}
                    <div className={`relative group transition-all duration-1000 ease-out delay-[600ms] ${
                      loaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'
                    }`}>
                    ...
                    <div className={`relative group transition-all duration-1000 ease-out delay-[700ms] ${
                      loaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'
                    }`}>
                        <label htmlFor="password_confirmation" className="block text-sm font-bold text-gray-700 mb-1">Konfirmasi Password</label>
                        <div className="relative">
                            <input 
                    ...
                    {/* Tombol Daftar & Masuk */}
                    <div className={`flex items-center gap-4 pt-6 transition-all duration-1000 ease-out delay-[800ms] ${
                      loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                    }`}>
                        <button 
                            type="submit" 
                            disabled={!canSubmit}
                            className={`flex-1 px-6 py-3 text-white rounded-full font-bold shadow-lg transition-all duration-300 text-base ${
                                canSubmit 
                    ...
                    <div className={`mt-6 w-full text-center transition-all duration-1000 ease-out delay-[900ms] ${
                      loaded ? 'opacity-100' : 'opacity-0'
                    }`}>
                        <span className="text-sm text-gray-400">Sudah punya akun? </span>
                        <Link className="text-sm text-red-600 font-bold hover:underline transition-colors" href={route('login')}>
                            Login di sini
                        </Link>
                    </div>
                </form>
                ...
                {/* Footer Copy */}
                <div className={`mt-8 text-xs text-gray-400 text-center transition-all duration-1000 delay-1000 ${
                  loaded ? 'opacity-100' : 'opacity-0'
                }`}>
